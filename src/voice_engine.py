...
class AthenaVoice:
    ...
    def __init__(self, whisper_model="tiny", tts_lang='en'):
        """Initialize voice engine"""
        self.whisper_model_name = whisper_model
        self.tts_lang = tts_lang
        self.whisper_model = None
        
        print(f"🎙️ Voice Engine initialized (lazy loading)")
        print(f"   Model '{self.whisper_model_name}' will load on first use")
    ...
    def _initialize_whisper(self):
        ...
        try:
            ...
            # Recommended for Windows: tiny (fastest), base, small
